...
function App() {
  return (
    <div>
      <Hero src={hero1} title="Article 1" />
      <Constrain>
        <SpacedBlock>
          <p>
          ...
          <p>
            ...
            told him just what I think, tell him everything I would, let him
            know just what I feel. He'd fall right off his desk!
          </p>
          ...
          <p>
            ...
            ticking on the chest of drawers. "God in Heaven! " he thought. It
            ...
            clock not rung? He could see from the bed that it had been set for
            four o'clock as it should have been; it certainly must have rung.
            Yes, but was it possible to quietly sleep through that
            furniture-rattling noise? True, he had
          </p>
        </SpacedBlock>
      </Constrain>
    </div>
