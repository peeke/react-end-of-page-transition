...
export default function Article2(props) {
  return (
    <ArticleTemplate
      hero={<Hero src={hero2} title="Article 2" />}
      teaser={<NextArticleTeaser to="page3" src={hero3} title="Article 3" />}
    >
      <SpacedBlock>
        <p>
        ...
        <p>
          ...
          their projects again and again. And if she hasn’t been rewritten, then
        ...
        <p>
          ...
          decided to leave for the far World of Grammar. The Big Oxmox advised
