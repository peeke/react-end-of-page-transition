...
export default function Article3(props) {
  return (
    <ArticleTemplate
      hero={<Hero src={hero3} title="Article 3" />}
      teaser={<NextArticleTeaser to="page1" src={hero1} title="Article 1" />}
    >
      <SpacedBlock>
        <p>
        ...
        <p>
          ...
          beloved mistress, then I often think with longing, Oh, would I could
        ...
        <p>
          ...
          sustains us, as it floats around us in an eternity of bliss; and then,
          my friend, when darkness overspreads my eyes, and heaven and earth
          seem to dwell in my soul and absorb its power, like
        </p>
      </SpacedBlock>
    </ArticleTemplate>
  )
