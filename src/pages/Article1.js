...
import SpacedBlock from 'components/layout/SpacedBlock'
import NextArticleTeaser from 'components/next-article-teaser/NextArticleTeaser'

export default function Article1(props) {
  return (
    <ArticleTemplate
      hero={<Hero src={hero1} title="Article 1" />}
      teaser={<NextArticleTeaser to="page2" src={hero2} title="Article 2" />}
    >
      <SpacedBlock>
        <p>
        ...
        <p>
          ...
          slid back into his former position. "Getting up early all the time",
        ...
        <p>
          ...
          kicked out on the spot. But who knows, maybe that would be the best
          ...
          just what I feel. He'd fall right off his desk!
        </p>
        ...
        <p>
          ...
          definitely what I'll do. That's when I'll make the big change. First
          of all though, I've got to get up, my train leaves at five. " And he
          ...
          through that furniture-rattling noise? True, he had
        </p>
      </SpacedBlock>
    </ArticleTemplate>
  )
